    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-12" style="margin-top: 5%; font-weight:bolder; text-align: center; font-size: 20px; color: black;">
                ...
                Jeevan Solvent Extracts Private Limited's Annual General Meeting (AGM) was last held on 30 December 2020
                and
                as per records from Ministry of Corporate Affairs (MCA),
                its balance sheet was last filed on 31 March 2020 Current status of Jeevan Solvent Extracts Private
                Limited is - Active.
            </div>
        </div>
    </div>
                        ...
                        <div class="fadeshop">
                            <div class="captionshop text-center" style="display: none;">
                                ...
                                <p>
                                    ...
                                    Rice Bran Oil (Crude), which is extracted through refining the bran of the rice
                                    kernel.
                                </p>
                                <p>
                                    <a href="login.php" class="learn-more detailslearn">
                    ...
                    <div class="productbox">
                        <div class="fadeshop">
                            ...
                            <span class="maxproduct">
								<img src="./images/neem_img.jpg" alt="">
							</span>
                        </div>
                        <div class="product-details">
                            <a href="#">
            ...
            <div class="col-md-10 col-md-offset-1">
                <div class="slide-text">
                    <div>
                        ...
                        <p>
                            He have a variety of duties depending on where they work, but they typically are responsible
                            for developing the company's strategies, providing strategic advice to various
                            organizational leaders, and helping the company to achieve its goals.
                        </p>
                        <br><br>
                    </div>
                </div>
                ...
                <div class="col-lg-4" style="float: left; margin-top:3%;">
                    ...
                    <address>
                        <p>Jeevan Solvent Extracts Pvt.Limited,<br>Salem-Kallakurichi MainRoad<br> Royappanur,
                            Melnariyappanur Post Kallakurichi<br>Taluk Viluppuram, Tamil Nadu, 606201 India <br> Phone:
                            09790229890
						</p>
                    </address><br>
                </div>
