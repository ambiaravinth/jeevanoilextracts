                ...
                <form class="signup-form" method="post">
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="text" class="form-control" id="pass" name="password" value="<?php echo "$password" ?>" readonly />
                        </div>
                    </div>
                    <div class="row" style="margin-top:2%;">
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="text" class="form-control" id="pan_no" name="pan" value="<?php echo "$name" ?>" readonly />
                        </div>
                    </div>
                    <div class="row" style="margin-top:2%;">
                        <div class="col-md-4">
                            <label for="email" class="form-label">Email :</label>
                            <input type="email" class="form-control" id="email" value="<?php echo "$email" ?>" name="Email_ID" readonly />
                        </div>
                        <div class="col-md-4">
                            <label for="name" class="form-label">GST NO:</label>
                            <input type="text" class="form-control" id="gst" value="<?php echo "$gst" ?>" name="gstno" readonly />
                        </div>
                    </div>
                    <div class="row" style="margin-top:2%;">
                        <div class="col-md-4">
                            <label for="mobile" class="form-label">Mobile number :</label>
                            <input type="text" class="form-control" id="mobile" value="<?php echo "$number" ?>" name="Mobile_No" readonly />
                        </div>
                        <div class="col-md-4">
                            <label for="address" class="form-label">Address :</label>
                            <input type="textarea" class="form-control" id="address" value="<?php echo "$address_no" ?>" name="adrs" readonly />
                        </div>
                    </div>
                    <div class="col-12" style="margin-top:2%; margin-left:15% "><br>
